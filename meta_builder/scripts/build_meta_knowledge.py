...
#
# 组合关系：
#   meta_builder/scripts --> meta_builder/services/meta_knowledge_service --> 三大存储 Repository
#
# 使用方式：
#   python -m meta_builder.scripts.build_meta_knowledge -c /path/to/meta_config.yaml
#
# 与 server/core/lifespan.py 的区别：
